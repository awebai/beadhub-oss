...
description: "How project policies and role playbooks guide agent behavior in BeadHub."
weight: 40
menu_title: "Roles & Policies"
---
...
1. **Project policy** — project-wide rules that apply to all agents (e.g., "use mail-first communication", "track work in bdh").
...
Role playbook (coordinator):
  ...
  - Delegate tasks; avoid coding by default
```
...
|------|------------------------|
| `developer` | General development — implement features, fix bugs, write tests |
| `coordinator` | Triage issues, delegate work, monitor agent activity |
| `frontend` | UI and client-side development |
| `backend` | Server-side development, APIs, database work |
